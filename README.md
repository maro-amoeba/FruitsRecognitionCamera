...
スクリプト上では良い学習精度を示しているのにどうしてでしょうか。

試しに、画像の拡張(訓練画像の回転やら縮小)を施したモデルで識別してみましたがダメでした。  

学習のさせ方というより、選んだデータセットが間違いであったことに気づきました。  
例えば一つのクラスの画像フォルダの中にはこのような画像が600枚ほど入っています。
![image](https://user-images.githubusercontent.com/37995730/64467938-2552f900-d159-11e9-9a9b-dbda1fd48ae7.png)
このように**一種につき一個のフルーツを多角的に撮影したもの**が格納されています。  
これではデータセットとして不適切でした。  
